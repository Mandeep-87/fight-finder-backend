...
CSRF_TRUSTED_ORIGINS = ['http://65.0.94.158:8000']

BACKEND_SITE_URL = 'http://65.0.94.158:8000'
...
ASGI_APPLICATION = 'contract_project.asgi.application'
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [("127.0.0.1",6379)],  # Replace with the correct Redis server host and port
        },
    },
}
