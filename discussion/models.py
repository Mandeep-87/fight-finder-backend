...
class affiliation_section(models.Model):
    ...
    affiliation_position = models.CharField(max_length=255)
...
class Chat(models.Model):
    ...
    receiver = models.ForeignKey(User, related_name='receiver_user', on_delete=models.CASCADE, blank=True, null=True)
...
class GroupChatMessage(models.Model):
    ...
    receiver = models.ForeignKey(User, related_name='group_chat_receiver', on_delete=models.CASCADE,blank=True, null=True)
