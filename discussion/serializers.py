from .models import Post,Notification,SearchHistory,Follow,affiliation_section,Affiliation,Chat
...
class UserAllSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'username', 'email', 'is_staff', 'first_name', 'last_name',
                  ...
                  'Social_media_links', 'following', 'follower','location','dob')
...
class ChatSerializer(serializers.ModelSerializer):
    sender = UserPostSerializer()
    receiver = UserPostSerializer()
...
class ConsumerDetailSerializers(serializers.ModelSerializer):
 
    class Meta:
        model = User
        fields  = ('id','username','first_name','last_name','about_me','profile_image_update') 