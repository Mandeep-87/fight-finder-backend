...
class Events(models.Model):
    ...
    contact_title = models.CharField(max_length=2000)
...
class SeminarInformation(models.Model):
    ...
    social_media_links  = models.CharField(max_length=2000,blank=True,null=True)
    does_this_event_accept_foreign_participants  = models.CharField(max_length=2000,default=False, null=True,blank=True)
    why_is_this_seminar_only_open_to_this_group_of_people  = models.CharField(max_length=2000,null=True,blank=True)
    cost_of_seminar = models.CharField(max_length=2000,blank=True,null=True)
    start_date = models.DateField(default=None,null=True, blank=True)
    end_date = models.DateField(default=None,null=True, blank=True)
    # dates_of_seminar = models.CharField(max_length=255)
    special_instructions = models.CharField(max_length=2000, null=True,blank=True)
    ...
    updated_at =models.DateField(auto_now=True, editable=False,null=True,blank=True)
    is_approved = models.BooleanField(default=False)    
    online_only = models.CharField(max_length=2000,default=False, null=True,blank=True)
    modified = models.DateTimeField(auto_now=True, editable=False)
    martial_art_style = models.CharField(max_length=120,null=True,blank=True)
    website = models.CharField(max_length=2000,default="",blank=True,null=True)     
    event_flyer_material = models.CharField(max_length=2000,blank=True,null=True)  
...
class SchoolGym(models.Model):
    ...
    SchoolGym_email  = models.EmailField(max_length=255)
    price_min_ranges  = models.IntegerField(null=True,blank=True)
    price_max_ranges  = models.IntegerField(null=True,blank=True)
    days_of_operation  = models.IntegerField(null=True,blank=True)
    hours_of_operation  = models.CharField(max_length=255,null=True,blank=True)
    introduction  = models.CharField(max_length=255,null=True,blank=True)
    owner_social_media_links = models.CharField(max_length=255,null=True,blank=True)
    ...
    Google_My_Business= models.CharField(max_length=255,null=True, blank=True)
    School_picture = models.CharField(max_length=255,null=True, blank=True)
    Entry_Associate= models.CharField(max_length=255,null=True, blank=True)
    status = models.BooleanField(default=False)
